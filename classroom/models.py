...
# from media.visionapi.visionapi_demo import *
import misaka

# from media.visionapi.visionapi_demo import api
...
class ClassAssignment(models.Model):
    ...
    assignment = models.ImageField(upload_to='assignments')
...
#     # student = models.ManyToManyField(Student,related_name='student_assignment')
#     # teacher = models.ForeignKey(Teacher,related_name='teacher_assignment',on_delete=models.CASCADE)
#     keywords_name = models.CharField(max_length=250)
    
#     def __str__(self):
#         return self.keywords_name
